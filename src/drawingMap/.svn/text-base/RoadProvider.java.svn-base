...
class KMLHandler extends DefaultHandler {
                ...
                if (mString.length() > 0) {
                        if (localName.equalsIgnoreCase("name")) {
                                if (isPlacemark) {
                                        ...
                                        mRoad.mName = mString; //set road name
                                }
                                ...
                                if (isPlacemark) {
                                        ...
                                        if (!isRoute){
                                                ...
                                                mRoad.mDescription = description; //set distance
                                                findDistance(mRoad.mDescription);
                                        }
        ...
        public void findDistance(String mDescription){          
     	   String[] splitMdes1 =  mDescription.split(" ");
     	   String[] splitMdes2 =  splitMdes1[1].split("km");
     	   mRoad.setDistance(Double.valueOf(splitMdes2[0]));
        }
